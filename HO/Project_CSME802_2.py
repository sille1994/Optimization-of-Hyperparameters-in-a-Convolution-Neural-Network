...
#best_parameters, values, experiment, model = optimize(parameters=[{"name": "lr", "type": "range", "bounds": [1e-5, 0.1], "log_scale": False}, {
#                                                      "name": "momentum", "type": "range", "bounds": [0.2, 0.6]}, ], evaluation_function=evaluate_Hyperparameters, objective_name='accuracy',)
...
#    best_objectives, axis=1), title="Model performance vs. # of iterations", ylabel="Classification Accuracy, %",)
